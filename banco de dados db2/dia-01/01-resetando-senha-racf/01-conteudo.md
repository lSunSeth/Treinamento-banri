...
![alt text](assets/software-pzp.png)
...
![alt text](assets/pzp-aplicacoes.png)
...
![alt text](assets/pcentral-droscoe.png)
...
![alt text](assets/droscoe-menu.png)

Após estes passos terem sido concluídos, uma mensagem semelhante à que está na imagem abaixo aparecerá na tela, indicando que o processo foi concluído e que a senha foi atualizada com sucesso.

![alt text](assets/droscoe-sucesso.png)
